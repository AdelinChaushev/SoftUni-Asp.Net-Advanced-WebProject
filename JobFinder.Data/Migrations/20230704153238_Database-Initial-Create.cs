        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryDescription = table.Column<string>(type: "nvarchar(270)", maxLength: 270, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyDescription = table.Column<string>(type: "nvarchar(800)", maxLength: 800, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterviewStart = table.Column<DateTime>(type: "datetime2", nullable: false),
                    InterviewEnd = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Interviews", x => new { x.CompanyId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    JobTitle = table.Column<string>(type: "nvarchar(35)", maxLength: 35, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    SalaryPerMonth = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    VaccantionDays = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobListings_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewSumary = table.Column<string>(type: "nvarchar(35)", maxLength: 35, nullable: false),
                    AdditionalComment = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    CompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobApplications", x => new { x.JobListingId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobListings_ScheduleId",
                table: "JobListings",
                column: "ScheduleId");
